...
namespace pyr {
    ...
    void PropertyGridUpdater::visitGeometry(GeometryElement* e) {
        ...
        _grid->SetCellValue("x", 1, 0);         _grid->SetCellValue(va("%f", e->pos[0]).c_str(), 1, 1);
        _grid->SetCellValue("y", 2, 0);         _grid->SetCellValue(va("%f", e->pos[1]).c_str(), 2, 1);
    ...
    void PropertyGridUpdater::visitGroup(GroupElement* e) {
        ...
        setGridHeight(2);
        _grid->SetCellValue("x", 0, 0);         _grid->SetCellValue(va("%f", e->pos[0]).c_str(), 0, 1);
        _grid->SetCellValue("y", 1, 0);         _grid->SetCellValue(va("%f", e->pos[1]).c_str(), 1, 1);
        _grid->AutoSizeColumn(0);
